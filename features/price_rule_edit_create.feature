Feature: Create and Edit price rules
  ...
  Background:
    ...
    | 22 | Easter                      | 205   | per_night   | all_guests | 1          | 2          | 19-4       | 22-4     |                   |                   | Stays at the easter period are charged at $205 per night. | 
    | 23 | Cleaning                    | 10    | fixed       | all_guests |            |            |            |          |                   |                   | A fixed $10 charge applies for cleaning.                  |
    | 24 | 7 night stay                | 170   | per_night   | all_guests | 1          | 2          |            |          | 7                 | 7                 | Stays for 7 nights are charged at $170 per night.         | 
    | 25 | stays longer than 7 nights  | 165   | per_night   | all_guests | 1          | 2          |            |          | 8                 |                   | Stays for 8 or more nights are charged at $165 per night. |  
  ...
  Scenario: Edit an existing price rule
    ...
    And I choose "price_rule_rate_type_all_guests"
    And I press "Save"
